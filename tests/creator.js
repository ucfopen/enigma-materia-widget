describe('Enigma', function() {
	...
	describe('Creator Controller', function() {
		...
		beforeAll(module('enigmaCreator'));
		...
		beforeAll(inject(function($rootScope, $controller, _$timeout_){
			...
			$scope = $rootScope.$new();
			ctrl = $controller('enigmaCreatorCtrl', { $scope: $scope });
		}));
		...
		it('should not save if any questions are invalid', function(){
			...
			"Question 1 in category Cat5: Warning: this question is incomplete!\n"+
			"Question 1 in category Cat5: Question undefined.\n"+
			"Question 1 in category Cat5: Inadequate credit.\n"+
			"Question 1 in category Cat5: Duplicate answers.\n"+
			"Question 1 in category Cat5: Blank answer(s).");
		});
	...
	//start a new block of tests to essentially 'reset' the scope between each test
	describe('Creator Controller Again', function(){
